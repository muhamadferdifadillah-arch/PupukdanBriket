    ...
    <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
            <li class="nav-item border-dashed {{ request()->routeIs('user.category', 'compost') ? 'active' : '' }}">
                <a href="{{ route('user.category', 'compost') }}" class="nav-link d-flex align-items-center gap-3 text-dark p-2">
            ...
            <li class="nav-item border-dashed {{ request()->routeIs('user.category', 'charcoal') ? 'active' : '' }}">
                <a href="{{ route('user.category', 'charcoal') }}" class="nav-link d-flex align-items-center gap-3 text-dark p-2">
            ...
            <li class="nav-item border-dashed {{ request()->routeIs('user.category', 'liquid-compost') ? 'active' : '' }}">
                <a href="{{ route('user.category', 'liquid-compost') }}" class="nav-link d-flex align-items-center gap-3 text-dark p-2">
