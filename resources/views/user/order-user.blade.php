                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex align-items-center gap-3 mb-2">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1" style="font-size: 0.95rem;">{{ $item->product->name }}</h6>
                                ...
                                <div class="border-top pt-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <p class="mb-0" style="font-size: 0.9rem;">{{ $order->phone }}</p>
                                            </div>
                                            @if($order->courier)
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <p class="mb-0" style="font-size: 0.9rem;">{{ $order->tracking_number }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="bg-light p-3 rounded" style="border-radius: 8px;">
                                        ...
                                        <div class="d-flex justify-content-between mb-2">
                                            ...
                                            <small class="fw-medium">Rp {{ number_format($order->orderItems->sum(fn($i)=>$i->price * $i->quantity),0,',','.') }}</small>
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-between mb-2 text-success">
                                            <small>Diskon</small>
                                            <small class="fw-medium">- Rp {{ number_format($order->discount,0,',','.') }}</small>
                                        </div>
                                        @endif
