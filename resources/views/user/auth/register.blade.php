    ...
    <div class="w-full max-w-md animate-fade-in">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 md:p-10">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-600 text-base">Create your account and start growing with us.</p>
            </div>
            ...
            <!-- Form Register USER -->
            <form action="{{ route('user.register.post') }}" method="POST" autocomplete="off">
                @csrf
                ...
                <p class="text-center text-gray-600 text-sm mt-6">
                    ...
                    <a href="{{ route('user.login') }}" class="text-blue-600 hover:text-blue-700 font-semibold">
                        Log in.
                    </a>
                </p>
            </form>
