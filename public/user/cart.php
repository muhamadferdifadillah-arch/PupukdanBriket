  ...
  <div class="cart-header">
    <div class="container-lg">
      <a href="index.html" style="display: inline-block; margin-bottom: 20px;">
        <img src="user/images/logom.png" alt="logo" style="width: 80px; height: auto;">
      </a>
      ...
      <div class="col-lg-4">
        <div class="cart-summary" style="position: sticky; top: 20px;">
          ...
          <div style="text-align: center; margin-top: 15px;">
            <a href="index.html" style="color: #00a651; text-decoration: none; font-weight: 600;">← Lanjut Belanja</a>
          </div>
        </div>
      </div>
    </div>
      ...
      if (cart.length === 0) {
        container.innerHTML = `
          <div class="empty-state">
            ...
            <a href="index.html" style="color: white; text-decoration: none; background: #00a651; padding: 10px 30px; border-radius: 6px; display: inline-block;">← Kembali Belanja</a>
          </div>
        `;
